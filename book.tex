...
\newcommand{\adaptername}{于儿} % Your full name
\newcommand{\adapteremail}{yverrr@gmail.com} % Your email address
...
\renewcommand{\chaptername}{索引}

\addcontentsline{toc}{chapter}{主题索引}
\printindex

\addcontentsline{toc}{chapter}{词汇索引}
\printindex[vocabulary]

\addcontentsline{toc}{chapter}{符号索引}
\printindex[notation]

\addcontentsline{toc}{chapter}{\LaTeX{} 命令索引}
\printindex[latex]%
}
