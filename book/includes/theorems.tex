...
\declaretheorem[style=infdescimptthm, sibling=theorem, Refname={定理}, name={Theorem\assumesAC{thmcolac}}]{theoremac}
...
\declaretheorem[style=infdescthm, sibling=theorem, refname={引理}, Refname={引理}, name={Lemma\assumesAC{thmcolac}}]{lemmaac}
...
\declaretheorem[style=infdescthm, sibling=theorem, refname={命题}, Refname={命题}, name={Proposition\assumesAC{thmcolac}}]{propositionac}
...
\declaretheorem[style=infdescthm, sibling=theorem, refname={推论}, Refname={推论}, name={Corollary\assumesAC{thmcolac}}]{corollaryac}
...
\declaretheorem[style=infdescimptdef, sibling=theorem, refname={定义}, Refname={定义}, name={Definition\assumesAC{defcolac}}]{definitionac}
...
\declaretheorem[style=infdescex, sibling=theorem, refname={示例}, Refname={示例}, name={Example\assumesAC{excolac}}]{exampleac}
